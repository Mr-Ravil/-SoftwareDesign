...
import user.account.config.HttpDaoContextConfiguration;
import user.account.controller.UserController;
...
//        UserJdbcDao userJdbcDao = configuration.userJdbcDao(configuration.dataSource());
    ...
    @Test
    public void negativeUserBalanceTest() {
        String name = "name";
        long balance = 100;
        int uid = Integer.parseInt(controller.addUser(name, balance));
        ...
        assertThrows(AssertionError.class, () -> controller.changeBalance(uid, addBalance));
    ...
    public void changeStockAmountTest() throws IOException, URISyntaxException, InterruptedException {
        ...
        long addAmount = 300;
        post(changeStockAmountUri(sid, addAmount));
    ...
    @Test
    public void negativeStockAmountTest() throws IOException, URISyntaxException, InterruptedException {
        String companyName = "company";
        long price = 300;
        long amount = 200;
        ...
        long decreaseAmount = -300;
        post(changeStockAmountUri(sid, decreaseAmount), 500);
    ...
    public void buyStockTest() throws IOException, URISyntaxException, InterruptedException {
        ...
        // the stock's price don't change
    ...
    private static String changeStockAmountUri(int stockId, long amount) {
        return URL + "change_amount?stockId=" + stockId + "&amount=" + amount;
    }
    ...
    private static String setPriceUri(int stockId, long newPrice) {
        return URL + "set_price?stockId=" + stockId + "&newPrice=" + newPrice;
    }
